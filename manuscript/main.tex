...
Dtrios method in Dsuite \citep{malinsky_dsuite_2021}.
...
admixture.
% 
This includes a complex formed by \emph{D. ramosum}, \emph{D. robustum}, and \emph{D. alpestre} in the Southern Rocky Mountains, which is polyphyletic in all of our phylogenetic analyses, 
and a complex formed by \emph{D. distichum}, \emph{D. nuttallianum}, and \emph{D. multiplex} in the Pacific Northwest, which has the hybrid taxon name \emph{D.} x \emph{diversicolor} Rydberg. These taxa were also polyphyletic in all of our phylogenetic analyses.

For each species complex, we investigated phylogeny and admixture for the samples in this complex in isolation, and in combination with other taxa that showed evidence of admixture with them in the full Fbranch analysis. 
...
\begin{figure}[t!]
	\centering
	  \includegraphics[width=0.99\textwidth]{./figures/ramosum-robustum-alpestre}	
	\caption{
