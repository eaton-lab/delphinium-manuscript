...
sect. \emph{Diedropetala} (Ranunculaceae)\textcolor{red}{. After originating in the Himalaya-Hengduan region of Asia \textasciitilde~32 Ma, \emph{Delphinium} diversified into 650-700 species, speciating both west (through Eurasia, the Mediterranean, and into Africa) and east, arriving in western North America \textasciitilde~3 Ma, where it rapidly radiated into approximately 60 species} \citep{jabbour_phylogeny_2012}.
% 
...
\emph{Delphinium}, including the type specimen for subsections \emph{Bicoloria}, \emph{Exaltata}, \emph{Multiplex}, and \emph{Subscaposa}.}
...
concordance with the following biogeographic regions: GB1 and GB2 (Great Basin), PNW (Pacific Northwest), CAL (California), IMW (Intermountain West), ALCAN (Alaska/Canada), ENA (Eastern North America), and SW (Southwestern US) (Fig.~\ref{fig:sptree}a-b). 
% 
None of these
